  ...
  return (
    <div style={{minHeight:"100vh",background:"#0d0d0d",color:"#e0d5c1",fontFamily:"'DM Mono','IBM Plex Mono','Courier New',monospace"}}>
      ...
      <main style={{maxWidth:1020,margin:"0 auto",padding:"24px 32px 60px"}}>
        ...
        <div ref={function(el){sectionRefs.current["nav-summary"]=el}} id="section-summary" style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:1,background:"#1a1a1a",border:"1px solid #1a1a1a",marginBottom:24,scrollMarginTop:52}}>
          {[{l:"Federal-Owned",v:fedAcres.toLocaleString()+" ac"},{l:"State-Leased",v:leaseAcres.toLocaleString()+" ac"},{l:"Total Acreage",v:totalAcres.toLocaleString()+" ac"},{l:"Total Paid",v:fmtFull(totalPaid)},{l:"Back Rent Owed",v:fmt(grandTotal),hi:true}].map(function(x,i){
